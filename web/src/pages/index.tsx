...
const advantages = [
  ...
  },
  {
    ...
    description: 'Issue a certificate of completion that truly demonstrates your achievement in the course.',
    icon: DocumentTextIcon,
  },
  {
    name: 'Student community',
    description: 'Share your learning journey with thousands of others everyday with the exclusive community.',
    icon: ChatIcon,
  },
  {
    name: 'Practical challenges',
    description: 'Receive real-world challenges to test your skills with each technique learned during the courses.',
    icon: CheckCircleIcon,
  },
  {
    name: 'Recommendation to the market',
    description: 'Get recommendations for great jobs to start your programming career at the end of the course.',
    icon: CashIcon,
  },
  {
    name: 'Lifetime access',
    description: "Don't be in a hurry to study, get lifetime access to course content to study whenever you want.",
    icon: ClockIcon,
  },
]
const blogPosts = [
          ...
          <main>
                  ...
                  <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                    <div className="lg:py-24">
                      ...
                      >
                        ...
                        <span className="ml-4 text-sm">See our vacancies</span>
                        <ChevronRightIcon className="ml-2 w-5 h-5 text-gray-500" aria-hidden="true" />
                      </a>
                      <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                        <span className="block">Courses of</span>
                        <span className="pb-3 block bg-clip-text text-transparent bg-gradient-to-r from-teal-200 to-cyan-400 sm:pb-5">
                          programming
                        </span>
                      </h1>
                      <p className="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">                        
                        Learn programming through practical courses with lots of code and master the technologies of your day-to-day.
                      </p>
                    </div>
                  </div>
            ...
            <div className="relative bg-white py-16 sm:py-24 lg:py-32">
              <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
                <h2 className="text-base font-semibold tracking-wider text-cyan-600 uppercase">All You Need</h2>
                    ...
                    <blockquote>
                      <div>
                        ...
                        <p className="mt-6 text-2xl font-medium text-white">
                          After I started studying on this platform I was able to take on my own personal projects, work in the company of my dreams and see the next steps in my career.
                        </p>
                      </div>
                      <footer className="mt-6">
                        <p className="text-base font-medium text-white">Carolina Torres</p>
                        <p className="text-base font-medium text-cyan-100">Software Engineer @ CompanyOfDreams</p>
                      </footer>
                    </blockquote>
                  </div>
                </div>
